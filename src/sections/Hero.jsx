...
export const Hero = () => {
  ...
  return (
    // FIX MOBILE: Menggunakan min-h-[100dvh] agar dinamis memotong bar navigasi HP & w-full overflow-x-hidden
    <section className="relative min-h-[100dvh] w-full flex flex-col justify-center overflow-x-hidden py-12 md:py-20 bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-20 relative z-10">
        {/* FIX MOBILE: Menggunakan items-center dan gap yang seimbang antara teks & gambar */}
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          
          {/* Kolom Kiri - Teks Konten & Aksi */}
          {/* FIX MOBILE: text-center di mobile, text-left di layar besar. order-2 agar teks berada di bawah foto saat mobile */}
          <div className="space-y-6 md:space-y-8 flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1">
            ...
            {/* Headline */}
            {/* FIX MOBILE: Skala teks disesuaikan (text-3xl ke text-7xl) agar tidak keluar layar */}
            <div className="space-y-4 w-full">
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold leading-tight tracking-tight animate-fade-in animation-delay-100">
              ...
              <p className="text-sm md:text-lg text-muted-foreground max-w-lg mx-auto lg:mx-0 animate-fade-in animation-delay-200">
            ...
            {/* Tombol CTAs */}
            {/* FIX MOBILE: flex-col di mobile agar tombol memenuhi lebar layar, flex-row di desktop */}
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center lg:justify-start animate-fade-in animation-delay-300">
            ...
            <div className="flex flex-col gap-3 w-full animate-fade-in animation-delay-400">
          ...
          {/* FIX MOBILE: order-1 menjamin foto muncul duluan di HP sebelum tumpukan teks panjang */}
          <div className="relative animate-fade-in animation-delay-300 order-1 lg:order-2 w-full max-w-[260px] sm:max-w-md mx-auto">
        ...
        <div className="mt-12 md:mt-16 flex justify-center animate-fade-in animation-delay-500">
          <a
            href="#skills-section"
        ...
        <div id="skills-section" className="mt-12 md:mt-16 border-t border-white/5 pt-12 md:pt-16">
          ...
          {/* Grid Flex Horizontal Monokrom */}
          {/* FIX MOBILE: Menyesuaikan margin, padding, serta celah gap grid agar dinamis mengikuti ukuran kontainer perangkat */}
            ...
            {skills.map((skill, idx) => (
              <div 
                ...
                style={{
                  ...
                  transform: isMounted ? "translateY(0px) scale(1)" : "translateY(40px) scale(0.9)",
                  transitionDelay: `${idx * 30}ms`, // Sedikit dipercepat per-renderan agar mulus di RAM HP
                }}
              >
                {/* Efek Monokrom */}
