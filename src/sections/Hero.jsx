        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-300">
              <Button size="lg" onClick={() => window.open("https://wa.me/628388979386", "_blank")}>
            ...
            <div className="flex items-center gap-4 animate-fade-in animation-delay-400">
              ...
              {[
                { icon: Github, href: "https://github.com/Kinguya123" },
                { icon: Instagram, href: "https://www.instagram.com/fikry__0998/" },
                { icon: PhoneCall, href: "https://wa.me/628388979386" },
              ].map((social, idx) => (
                <a
                  key={idx}
                  href={social.href}
